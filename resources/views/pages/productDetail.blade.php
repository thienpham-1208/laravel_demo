    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5">
            <div class="view-product">
                <img src="{{asset('images/product/'.$product_detail->image)}}" alt="" />
                <h3>ZOOM</h3>
            </div>
        ...
        <div class="col-sm-7">
            <div class="product-information"><!--/product-information-->
                ...
                <div id="formAdd">
                    <form action="{{asset(route('cart.add',$product_detail->id))}}" id="cate_form">
                        <label >Size:</label>
                        <input type="text" placeholder="Size" name="size"><br><br>
                    ...
                    {{-- <span>
                        <span>{{number_format($product_detail->price)}}$</span><br><br>
                         <form id="cart" action="">
                             Size:
